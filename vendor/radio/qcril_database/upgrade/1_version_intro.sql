...
DELETE FROM qcril_emergency_source_mcc_mnc_table WHERE MCC = '466' AND MNC = '05' AND NUMBER = '110';
INSERT INTO qcril_emergency_source_mcc_mnc_table VALUES('466','05','110','','');
DELETE FROM qcril_emergency_source_mcc_mnc_table WHERE MCC = '466' AND MNC = '05' AND NUMBER = '112';
INSERT INTO qcril_emergency_source_mcc_mnc_table VALUES('466','05','112','','');
DELETE FROM qcril_emergency_source_mcc_mnc_table WHERE MCC = '466' AND MNC = '05' AND NUMBER = '119';
